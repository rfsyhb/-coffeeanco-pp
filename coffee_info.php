    ...
    <div class="container mt-20">
        <div class="row pt-8 pb-8 g-16 align-items-center">
            ...
            <div class="col-12 col-md-6">
                ...
                <h2>ROAST LEVEL 03 MEDIUM/LIGHT</h2>
                <h1>The Pink Mandarin</h1>
                <p>A cup that takes you to warm sunsets and the aroma of spring blossoms.</p>
                <p>We endeavor to craft The Pink Mandarin blend that reflects the richness and uniqueness of Indonesian
