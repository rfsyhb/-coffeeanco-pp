                ...
                <div class="container-fluid px-4">
                    ...
                    <form action="update_order.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="cust_email" id="cust_email" value="<?php echo $data['cust_email']; ?>"
                                class="form-control" require>
                        </div>
                        <div class="mb-3">
                            <label>Customer Phone</label>
                            <input type="text" name="cust_phone" id="cust_phone" value="<?php echo $data['cust_phone']; ?>"
                                class="form-control" require>
                        </div>
                        <div class="mb-3">
                            <label>Customer Address</label>
                            <input type="text" name="cust_address" id="cust_address" value="<?php echo $data['cust_address']; ?>" 
                                class="form-control" require>
                        </div>
                        <div class="mb-3">
