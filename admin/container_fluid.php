    <div class="row g-3 my-2">
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <?php
                                    $query = mysqli_query($connect, "SELECT prod_id FROM product ORDER BY prod_id");
                    ...
                    <div class="col-md-3">
                        <div class="p-3 bg-white shadow-sm d-flex justify-content-around align-items-center rounded">
                            <div>
                                <?php
                                    $query = mysqli_query($connect, "SELECT id_subs FROM subscribing ORDER BY id_subs");
                                    $row = mysqli_num_rows($query);
                                    echo '<h3 class="fs-2">'.$row.'</h3>';
                                ?>
                                <p class="fs-5">Subscribers</p>
                            </div>
