                    ...
                    <div class="col">
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            <td><?php echo $data['id_subs']; ?></td>
                                            <td><?php echo $data['email_subs']; ?></td>
                                            <td>
                                                <a href="table_update_subscribing.php?id_subs=<?php echo $data['id_subs']; ?> " class="btn-sm btn-primary">
                                                    <span class="fas fa-edit">
                                                </a>
                                                <a href="delete_subscribing.php?id_subs=<?php echo $data['id_subs']; ?>" class="btn-sm btn-danger">
